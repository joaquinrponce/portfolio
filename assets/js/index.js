...
var Game = function () {
  ...
  var imageFileNames = ['assets/game/img/blackBomb.png', 'assets/game/img/redBomb.png', 'assets/game/img/blowBomb.png', 'assets/game/img/bombExplode.png', 'assets/game/img/background.png', 'assets/game/img/pauseButton.png', 'assets/game/img/restartButton.png', 'assets/game/img/continueButton.png', 'assets/game/img/startButton.png'];
  var images = {
    blackBomb: new Image(),
    redBomb: new Image(),
    blowBomb: new Image(),
  ...
  var sfx = {
    music1: new Audio('assets/game/sfx/music1.ogg'),
    music2: new Audio('assets/game/sfx/music2.ogg'),
    bombGrab: new Audio('assets/game/sfx/bombGrab.mp3'),
    bombExplosion: new Audio('assets/game/sfx/bombExplosion.mp3'),
    bombBeep: new Audio('assets/game/sfx/bombBeep.mp3')
  };
  ...
  function gameClickHandler(e) {
    ...
    if (e.changedTouches) {
      relativeX = e.changedTouches[0].clientX - rect.left
      relativeY = e.changedTouches[0].clientY - rect.top
    } else {
